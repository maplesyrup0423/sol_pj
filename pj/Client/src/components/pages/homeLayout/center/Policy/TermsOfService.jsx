  ...
  return (
    <>
      ...
      <div className="Policy-body">
        ...
        <ul>
          <li>sol903는 필요에 따라 이 약관을 변경할 수 있습니다.</li>
